...
! function(e, t) {
    ...
    var o = "fullpage-wrapper",
        a = "." + o,
        s = "covid19-responsive",
        l = "covid19-notransition",
        h = "covid19-destroyed",
        c = "covid19-enabled",
        u = "covid19-viewing",
        f = "active",
        d = "." + f,
        E = "covid19-completely",
        p = "." + E,
        m = "covid19-section",
        v = "." + m,
        g = v + d,
        ...
        R = "covid19-tableCell",
        x = "." + R,
        _ = "covid19-auto-height",
        b = "covid19-normal-scroll",
        H = "covid19-nav",
        w = "#" + H,
        M = "covid19-tooltip",
        S = "." + M,
        A = "covid19-show-active",
        C = "covid19-slide",
        L = "." + C,
        F = L + d,
        z = "covid19-slides",
        V = "." + z,
        U = "covid19-slidesContainer",
        B = "." + U,
        k = "covid19-table",
        D = "covid19-slidesNav",
        P = "." + D,
        N = P + " a",
        I = ".covid19-controlArrow",
        O = "covid19-prev",
        W = "covid19-controlArrow " + O,
        j = I + "." + O,
        G = "covid19-controlArrow covid19-next",
        X = I + ".covid19-next",
        Y = e(t),
        q = e(i);

...
root@LAPIG-SRV:/data/containers/APP_COVID19/APP/covid19/src/server/scripts# 
root@LAPIG-SRV:/data/containers/APP_COVID19/APP/covid19/src/server/scripts# cat atualizacao_automatica_casos.sh 
#!/bin/bash
